  ...
  return (
    ...
    >
      <Feature
        ...
        ratio={[1600, 894]}
        alt="The app's passport view showing two countries visited, 1,491 lifetime miles, two flights, stamps for Pakistan and Sri Lanka, and an achievements row with Maiden Flight unlocked."
      />
